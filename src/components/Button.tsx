...
// Writing a Wrapper Component that Renders Different Elements Conditionally:

/*
// APPROACH - 1 -------------------------------------------:
// Using discriminated unions with React's built-in ComponentPropsWithoutRef<T> utility type:
type ButtonProps = {
  elem: "button";
...
// This approach compells us to add the "elem" prop to every "Button" component instance to specify whether the Button component instance is a button or an anchor element. We can avoid this by using a built-in prop, that's unique to either of the two HTML elements, as the discriminitator in the conditionals inside the component logic, along with a type predicate (the isAnchorProps function below, in this case).
*/
