...
// React's built-in ElementType type restricts the type to a valid JSX element (div, main, aside, etc.) or an existing React functional component (like Button). The "T" type parameter is used as the identifier and placeholder for the type of the value the "asElement" prop will receive:
